...
export function TemplatePicker({ open, onClose, onInsert, anchorRef }: TemplatePickerProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "12px 14px 8px", borderBottom: "1px solid var(--seed-border)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <Hash size={14} style={{ color: "var(--seed-accent)" }} />
        ...
        >
          <Hash size={11} style={{ color: "var(--seed-muted)", flexShrink: 0 }} />
          <input
            value={searchQuery}
            ...
            style={{
              ...
              color: "var(--seed-fg)", fontSize: "var(--fs-12)",
      ...
      {/* New template form */}
      {showNewForm && (
        <div style={{ padding: 10, borderBottom: "1px solid var(--seed-border)", background: "var(--seed-surface)" }}>
          <input
            value={newTitle}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <input
              ...
              style={{
                ...
                background: "var(--seed-input-bg)", border: "1px solid var(--seed-border)",
                color: "var(--seed-fg)", fontSize: "var(--fs-11)",
            ...
            <div style={{ display: "flex", gap: 6 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "var(--seed-accent)", color: "#fff", border: "none",
          ...
          {displayCategories.map((cat) => (
            <button
              ...
              style={{
                ...
                background: activeCategory === cat ? "var(--seed-accent-bg)" : "transparent",
                color: activeCategory === cat ? "var(--seed-accent)" : "var(--seed-muted)",
                border: activeCategory === cat ? "1px solid var(--seed-accent-border)" : "1px solid var(--seed-border)",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <input
                  ...
                  style={{
                    ...
                    background: "var(--seed-input-bg)", border: "1px solid var(--seed-accent-border)",
                    color: "var(--seed-fg)", fontSize: "var(--fs-12)",
                    fontFamily: "inherit", outline: "none",
                  }}
                />
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  <div style={{ display: "flex", gap: 4 }}>
                    <button onClick={() => setEditingId(null)} className="cp" style={{ padding: "3px 10px", borderRadius: 5, fontSize: "var(--fs-11)", color: "var(--seed-muted)", background: "transparent", border: "1px solid var(--seed-border)" }}>
                      取消
                    </button>
                    <button onClick={saveEdit} className="cp" style={{ padding: "3px 10px", borderRadius: 5, fontSize: "var(--fs-11)", fontWeight: 500, background: "var(--seed-accent)", color: "#fff", border: "none", display: "flex", alignItems: "center", gap: 2 }}>
                      <Check size={10} /> 保存
                    </button>
                  </div>
                </div>
              ...
              <>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0 }}>
                    ...
                    {t.isBuiltin && (
                      <span style={{ fontSize: "var(--fs-9)", padding: "0 4px", borderRadius: 2, background: "var(--seed-hover-bg)", color: "var(--seed-muted)", fontWeight: 500 }}>
                        内置
                      </span>
                    )}
                  </div>
                ...
                <div
                  style={{
                    fontSize: "var(--fs-11)", color: "var(--seed-muted)",
      ...
      <div style={{ padding: "6px 14px", borderTop: "1px solid var(--seed-border)", fontSize: "var(--fs-10)", color: "var(--seed-muted)", textAlign: "center" }}>
        点击 <span style={{ color: "var(--seed-accent)" }}>›</span> 插入模板到对话
      </div>
    </div>
  );
}